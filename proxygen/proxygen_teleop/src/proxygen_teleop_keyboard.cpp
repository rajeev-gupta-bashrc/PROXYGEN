...
#include "proxygen_teleop/proxygen_teleop_keyboard.h"
...
{
  goal_joint_space_path_client_ = node_handle_.serviceClient<proxygen_msgs::SetJointPosition>("goal_joint_space_path");
  goal_joint_space_path_from_present_client_ = node_handle_.serviceClient<proxygen_msgs::SetJointPosition>("goal_joint_space_path_from_present");
  goal_task_space_path_from_present_position_only_client_ = node_handle_.serviceClient<proxygen_msgs::SetKinematicsPose>("goal_task_space_path_from_present_position_only");
  goal_tool_control_client_ = node_handle_.serviceClient<proxygen_msgs::SetJointPosition>("goal_tool_control");
}
...
void OpenManipulatorTeleop::kinematicsPoseCallback(const proxygen_msgs::KinematicsPose::ConstPtr &msg)
{
...
{
  // Init ROS node
  ros::init(argc, argv, "proxygen_teleop_keyboard");
  OpenManipulatorTeleop openManipulatorTeleop;
